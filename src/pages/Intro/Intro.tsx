...
function IntroComp() {
  ...
  return (
    <>
              ...
              <div className="">
                  ...
                  <ul className="list-disc ml-6 font-[500] space-y-4">
                    <li>
                      ...
                      <p>
                        ...
                        trữ, kiểm tra và hiển thị thông tin tổng quan về các
                        doanh nghiệp Dệt May. Dữ liệu có nhiều dạng, nhiều
                        trường.
                      </p>
                    </li>
                    <li>
                      <p>
                        <strong>Ứng dụng:</strong> Giúp nhìn rõ, phân tích và
                        thấu hiểu → khao sát, quản lý các nguồn lực và lập kế
                        hoạch phát triển.
                      </p>
                    </li>
                    <li>
                      <p>
                        <strong>Liên kết:</strong> Là cơ sở để tạo 1 nền tảng
                        sàn chơi số cho các doanh nghiệp: thư viện số chi tiết
                        về năng lực ngành, chợ thương mại điện tử về đơn hàng,
                        các hoạt động giao lưu trên mạng trong phạm vi ngành.
                      </p>
                    </li>
                  </ul>
                </div>
                ...
                <div className="mb-4">
                  ...
                  <Paragraph className="text-gray-700 leading-relaxed">
                    Cung cấp một bảng trình bày trực quan về dữ liệu gồm các
                    chức năng chính : Nhập liệu - Hiển thị dữ liệu - Quản lý dữ
                    liệu - Truy xuất dữ liệu - Phân tích dữ liệu.
                  </Paragraph>
                </div>
      ...
      {/* Animated Full Map Modal */}
      <div
        className={`fixed inset-0 bg-[#030303c7] z-50 transition-opacity duration-500 ease-in-out ${
          isOpen ? "opacity-100" : "opacity-0 pointer-events-none"
        }`}
      >
        <div
          className={`h-[100vh] w-[100vw] flex justify-center transition-transform duration-500 ease-in-out ${
            isOpen ? "scale-100" : "scale-50"
          }`}
        >
          <img
            src={fullmap}
            alt="Full Vietnam Map"
      ...
      <div
        className={`fixed top-[10px] right-[10px] z-50 transition-all duration-300 ${
          isOpen
